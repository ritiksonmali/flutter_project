...
class PushNotificationController extends GetxController {
  Future sendNotificationData(String deviceToken, String deviceType) async {
    ...
    String url = serverUrl +
        'api/auth/sendNotificationData?userId=${userId}&deviceToken=${deviceTokenToSendPushNotification}&deviceType=${deviceType}';
  ...
  Future setNotifiedUserStatus() async {
    ...
    String url = serverUrl +
        'api/auth/setNotifiedUserStatus?userId=${user_id}&deviceToken=${deviceTokenToSendPushNotification}';
    http.Response response = await http.post(
      Uri.parse(url),
      headers: {'Content-Type': 'application/json'},
    );
