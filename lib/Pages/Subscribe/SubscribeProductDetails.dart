    ...
    return SizedBox(
      ...
      child: GetBuilder<SubscribeProductController>(builder: (controller) {
        return controller.isloading.value
            ...
            : ListView.builder(
                shrinkWrap: true,
                itemCount: controller.subscribeProdutList.length,
                // scrollDirection: Axis.horizontal,
                physics: const ScrollPhysics(),
                itemBuilder: (context, index) {
                  var product = controller.subscribeProdutList[index];
                  return Column(
                    children: [
                      Center(
                        child: Container(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: SizedBox(
                                                              ...
                                                              child: IconButton(
                                                                ...
                                                                color: white,
                                                                onPressed: () {
                                                                  if (subscribeProductController.subscribeProdutList[index]
                                                                              [
                                                                              'inventory']
                                                                          [
                                                                          'quantity'] >
