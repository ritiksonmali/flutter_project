...
class _ProductListState extends State<ProductListPage> {
  int index=8;
  List<String> productName = ['Mango' , 'Orange' , 'Grapes' , 'Banana' , 'Chery' , 'Peach','Mixed Fruit Basket','Mixed Fruit Basket'] ;
  List<String> productUnit = ['25%' , '36%' , '6%' , 'Dozen' , 'KG' , 'KG','KG','KG'] ;
  List<int> productPrice = [10000, 20000 , 20500 , 25000 , 30000, 35000 , 35000 ,36999] ;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 5),
                                Text("49999rs" ,
                                  style: TextStyle( decoration: TextDecoration.lineThrough,fontSize: 16, fontWeight: FontWeight.w400),
                                ),
                                SizedBox(height: 5),
                                Text(productPrice[index].toString()+"rs 36% off" ,
                                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                                ),
                                 SizedBox(height: 5,),
                                Text("Discription",
