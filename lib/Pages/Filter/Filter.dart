...
//  Map<String, int> listItem = {'Men': 1, 'Women': 2, 'Fashion': 3,'kid': 4, 'Baby': 5, 'Fruit': 6};
 List listItem =[
  'Men','Women','Fashion','kid','Baby','Fruit',
 ];
   int startValue=0;
   int endValue=1500;
RangeValues _currentRangeValues = const RangeValues(0, 1500);
 ...
 List  listItemSorting  =[
  'Low to High Price','High to Low Price',
 ];
bool? check1 = false;
                      ...
                      print(check1.toString());
                        if(valueChooseSort.toString()=='High to Low Price'){
                            if(check1.toString()=='true'){
                              print('loop1');
                              productController.getFilterProducts('true','true',endValue,startValue,sortColumn,catagoryId);
                            }else{
                                 print('loop2');
                            productController.getFilterProducts('','true',endValue,startValue,sortColumn,catagoryId);
                           }
                        }else{
                             print('loop3');
                          if(check1.toString()=='true'){
                            print(check1.toString());
                              productController.getFilterProducts(check1.toString(),'false',endValue,startValue,sortColumn,catagoryId);
                            }else{
                                 print('loop4');
                            productController.getFilterProducts('','false',endValue,startValue,sortColumn,catagoryId);
                           }
                        }
                      Timer(Duration(seconds: 5), () {
                        Get.to(() => FilterProductList());
                      });
                    },
                  ), 
