...
AllOrdersDeliveryManager AllOrdersDeliveryManagerFromJson(String str) =>
    AllOrdersDeliveryManager.fromJson(json.decode(str));

String AllOrdersDeliveryManagerToJson(AllOrdersDeliveryManager data) =>
